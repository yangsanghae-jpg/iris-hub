...
from src.tabs import diagnosis_sot, external, flow, graph, intake, inventory, pptx, wiki
...
NAV_GROUPS: list[tuple[str, list[str]]] = [
    ("Core", ["diagnosis_sot", "intake", "flow"]),
...
def _sidebar_nav() -> str:
    if "iris_hub_nav" not in st.session_state:
        st.session_state.iris_hub_nav = "diagnosis_sot"
