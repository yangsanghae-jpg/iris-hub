...
- **A1.3 Ch3 MD 데이터팩 v0.3 (A~I, 74카드)** — 2026-07-07 진실원 반영: `docs/design/diag-sot/sources/a1_ch3_{A..I}_*_v0_3_2026-07-06.md` (9파일). diagnosis-tool 실데이터팩 동기: `docs/by_step/data/` 동경로. **JSON 백필·v0.3 변환 스크립트는 미적용**(MD authoring 정본 단계).
