...
- **A1.3 Ch3 MD 데이터팩 v0.3 (A~I, 74카드)** — 2026-07-07 진실원 반영: `docs/design/diag-sot/sources/a1_ch3_{A..I}_*_v0_3_2026-07-06.md` (9파일). diagnosis-tool 실데이터팩 동기: `docs/by_step/data/` 동경로. **2026-07-07 런타임 백필 적용**: `scripts/build_a1_ch3_process_detail_backfill_v03.py` → `process_detail_v1.json` + `subs_by_code` + `process_analysis.py` lookup.
